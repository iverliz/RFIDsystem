...
class Report(tk.Frame):
    ...
    def get_students(self):
        return self.fetch_data("SELECT id, name, date FROM students")

    def get_teachers(self):
        return self.fetch_data("SELECT id, name, date FROM teachers")

    def get_fetchers(self):
        return self.fetch_data("SELECT rfid, name, date FROM fetchers")
