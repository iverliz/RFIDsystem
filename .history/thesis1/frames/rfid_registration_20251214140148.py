...
class RfidRegistration(tk.Frame):
    def __init__(self, root):
        ...
        # Image Label
        self.image_label = tk.Label(self.fetcher_frame, bg="white", width=120, height=120)
    ...
    def upload_image(self):
        ...
        if file_path:
            ...
            self.fetcher_image = ImageTk.PhotoImage(img)
            self.image_label.config(image=self.fetcher_image)
