...
class MainDashboard(tk.Tk):
    def __init__(self, parent):
        ...
        logout_button = tk.Button(self.topbar, text="Logout", bg="#D9534F",activebackground="#C9302C",activeforeground="#F5F5F5", fg="#F5F5F5",reli, font=("Arial", 12, "bold"), command=self.logout)
