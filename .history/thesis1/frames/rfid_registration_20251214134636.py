...
class RfidRegistration(tk.Frame):
    def __init__(self, root):
        ...
        # ================= FETCHER (LEFT) =================
        self.fetcher_frame = tk.Frame(self, width=400, height=450, bg="white", bd=2, relief="groove")
        self.fetcher_frame.place(x=50, y=100)
        ...
        # ================= STUDENT (RIGHT) =================
        self.student_frame = tk.Frame(self, width=400, height=450, bg="white", bd=2, relief="groove")
        self.student_frame.place(x=900, y=100)
        ...
        button_frame.place(relx=0.5, y=180, anchor="center")
        ...
        self.tree.place(relx=0.5, y=500, anchor="center")
