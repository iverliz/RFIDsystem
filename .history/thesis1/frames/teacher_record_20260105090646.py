...
class TeacherRecord(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # ================= FORM =================
        tk.Label(self.left_box, text="Teacher Name:", bg="white", font=("Arial", 11))\
            .place(x=20, y=200)
        tk.Entry(self.left_box, textvariable=self.teacher_name_var, width=30, font=("Arial", 11))\
            .place(x=150, y=200)

        tk.Label(self.left_box, text="Grade:", bg="white", font=("Arial", 11))\
            .place(x=20, y=240)
        tk.Entry(self.left_box, textvariable=self.teacher_grade_var, width=30, font=("Arial", 11))\
            .place(x=150, y=240)

        # ================= BUTTONS (ALIGNED & VISIBLE) =================
        ...
        tk.Button(self.right_panel, text="Search", command=self.search_teacher)\
            .place(x=260, y=47)
