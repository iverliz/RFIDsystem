...
tk.Entry(self.student_left, textvariable=self.fullname_var, font=entry_font, width=30)\
...
tk.Entry(self.student_left, textvariable=self.grade_var, font=entry_font, width=30)\
...
tk.Entry(self.student_left, textvariable=self.student_id_var, font=entry_font, width=30)\
...
tk.Entry(self.student_left, textvariable=self.guardian_name_var, font=entry_font, width=30)\
...
tk.Entry(self.student_left, textvariable=self.guardian_contact_var, font=entry_font, width=30)\
