...
class Report(tk.Frame):
    ...
    def get_students(self):
        return self.fetch_data("SELECT id, name, date FROM student")

    def get_teachers(self):
        return self.fetch_data("SELECT ID, Teeacher_name, date FROM teacher")

    def get_fetchers(self):
        return self.fetch_data("SELECT ID, fetcher_name, date FROM fetcher")
