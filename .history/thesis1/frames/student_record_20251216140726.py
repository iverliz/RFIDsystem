...
class Student(tk.Frame):
    def __init__(self, root):
        ...
        #student box left  
        self.student_left = tk.Frame(self,width=1000, height = 500, bg = "white", bd="1.5", relief = "groove")
        self.stduent_left.place (x = 50, y = 100)
        self.student_left.pack.propagate(False)
