...
class Student(tk.Frame):
    def __init__(self, root):
        ...
        self.student_table.column("Student_id", width=150)
        self.student_table.column("Student_name", width=200)
        self.student_table.column("grade_lvl", width=120)
    ...
    def add_student(self):
        ...
        # Save image
        img_save_path = os.path.join(PHOTO_DIR, f"student_{student_id}.jpg")
