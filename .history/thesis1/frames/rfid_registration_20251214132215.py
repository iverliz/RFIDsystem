...
class RfidRegistration(tk.tk):
    def __init__(self, root):
        ...
        tk.Label(self.student_frame, text="Student :", bg="white").pack()
        self.rfid_label = tk.Label(self.student_frame, text="", bg="white")
        self.rfid_label.pack()

        tk.Label(self.student_frame, text="Address:", bg="white").pack()
        self.email_label = tk.Label(self.student_frame, text="", bg="white")
        self.email_label.pack()

        tk.Label(self.student_frame, text="Phone Number:", bg="white").pack()
        self.phone_label = tk.Label(self.student_frame, text="", bg="white")
        self.phone_label.pack()
