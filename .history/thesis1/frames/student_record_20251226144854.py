...
class Student(tk.Frame):
    def __init__(self, root):
        ...
        # ================= BUTTONS =================
        tk.Button(self.student_left, text="ADD",
                  command=self.add_student, bg="#4CAF50", fg="white").place(x=40, y=510)

        tk.Button(self.student_left, text="EDIT",
                  command=self.edit_student, bg="#2196F3", fg="white").place(x=180, y=510)

        tk.Button(self.student_left, text="DELETE",
                  command=self.delete_student, bg="#F44336", fg="white").place(x=320, y=510)
    ...
    def add_student(self):
        try:
            ...
            cursor.execute("""
                INSERT INTO student
                (Student_name, Student_id, grade_lvl,
    ...
    def edit_student(self):
        messagebox.showinfo("Info", "Edit logic works (not crashing)")

    def delete_student(self):
        messagebox.showinfo("Info", "Delete logic works (not crashing)")
