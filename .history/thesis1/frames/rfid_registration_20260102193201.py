...
class RfidRegistration(tk.Frame):
    def __init__(self, root):
        ...
        # ================= FETCHER FRAME =================
        self.fetcher_frame = tk.Frame(self, width=FRAME_WIDTH, height=FRAME_HEIGHT,
        ...
        # ================= STUDENT FRAME =================
        self.student_frame = tk.Frame(self, width=FRAME_WIDTH, height=FRAME_HEIGHT,
                                      bg="white", bd=2, relief="groove")
        ...
        student_fields = [
            ("Student RFID:", self.paired_rfid_var),
        ...
        tk.Button(self, text="ADD", width=12, font=("Arial", 14, "bold"),
                  bg="#4CAF50", fg="white", command=self.add_record).place(x=btn_x, y=btn_y)

        tk.Button(self, text="EDIT", width=12, font=("Arial", 14, "bold"),
                  bg="#2196F3", fg="white", command=self.edit_record).place(x=btn_x + 150, y=btn_y)

        tk.Button(self, text="DELETE", width=12, font=("Arial", 14, "bold"),
                  bg="#F44336", fg="white", command=self.delete_record).place(x=btn_x + 300, y=btn_y)

        # ================= TABLE =================
        columns = ("rfid", "fetcher_name", "address", "contact",
    ...
    def match_rfid(self, uid, role):
        ...
        try:
            ...
            rfid, name, addr, contact, sid, sname, grade, teacher, paired = row
