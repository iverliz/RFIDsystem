...
class RfidRegistration(tk.Frame):
    def __init__(self, root):
        ...
        student_fields = [
            ...
            ("Student ID:", self.student_rfid_var),
    ...
    def edit_record(self):
        ...
        try:
            ...
            cursor.execute("""
                ...
                grade=%s, teacher=%s, paired_rfid=%s, student_rfid=%s
                WHERE rfid=%s
            """, (
                self.name_var.get(), self.address_var.get(),
                self.contact_var.get(), self.student_id_var.get(),self.student_rfid_var.get(),
    ...
    def load_selected(self, _):
        ...
        (self.rfid_var.set(data[0]), self.name_var.set(data[1]),
         self.address_var.set(data[2]), self.contact_var.set(data[3]),self.student_rfid_var.set(data[4]),
         self.student_id_var.set(data[5]), self.student_name_var.set(data[6]),
         self.grade_var.set(data[7]), self.teacher_var.set(data[8]),
         self.paired_rfid_var.set(data[9]))

    def clear_fields(self):
        for v in (self.rfid_var, self.name_var, self.address_var,
                  self.contact_var, self.student_id_var,self.student_rfid_var,
