...
class MainDashboard(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # MENU BUTTONS
        for text in ["Student Record", "Teacher Record", "Fetcher Record",
                     "RFID Registration", "History Log", "Account Settings", "Reports"]:
        ...
        logout_button = tk.Button(
            self.topbar, text="Logout", bg="#ff6b6b", activebackground="#ff5252",
            fg="white", relief="flat", padx=15, pady=5, font=("Arial", 12, "bold"),
            command=self.logout
        )
    ...
    def create_menu_button(self, text):
        btn = tk.Button(
            self.sidebar, text=text, bg="#2ec7c0", fg="white",
            activebackground="#99dde7", activeforeground="white",
            anchor="w", relief="flat", padx=20, pady=15, font=("Arial", 12, "bold")
        )
...
class App(tk.Tk):
    def __init__(self):
        ...
        self.frames = {}
        for F in (LoginFrame, SignUpFrame, MainDashboard):
