...
class MainDashboard(tk.Tk):
    def __init__(self, parent):
        ...
        def create_menu_button(self, text):
            btn = tk.Button(self.sidebar, text=text, bg="#0",activebackground="#0047AB",activeforeground="#F5F5F5", fg="#F5F5F5",relief="flat",padx=15,pady=5, font=("Arial", 12, "bold"), command=self.show_frame)