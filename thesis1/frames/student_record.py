...
class StudentRecord(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # LINKED TO CLEAR_SEARCH for full UI and Table refresh
        ...
        self.student_table = ttk.Treeview(self.right_panel, columns=("Student_id", "Student_name", "grade_lvl"),
                                          show="headings", height=12, takefocus=False)

        for col, txt, w in [("Student_id", "Student ID", 120), ("Student_name", "Full Name", 220), ("grade_lvl", "Grade", 80) ]:
    ...
    def clear_fields(self):
        """Standard clearing of all form inputs."""
    ...
    def clear_search(self):
        """Full reset of search bar, table data, and UI state."""
        self.search_var.set("")
        self.search_results = []
        self.current_page = 1 
        self.load_data()
